                        ...
                        <div class="container-1">
                            ...
                            <div class="container-2">
                                ...
                                <div class="pt-1 mb-2 pb-1 mx-4">
                                    <div class="text-muted password">Ingresa la nueva contraseña. Recuerda colocar una contraseña segura para tu cuenta.</div>
                                </div>
                                ...
                                <form action="update_password.php" method="POST">
                                    ...
                                    <button type="submit" class="iniciar-sesion mb-3">Restablecer Contraseña</button>
                                </form>
                            </div>      
                        </div>
                    </div>
