        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a href="../user/login.php" class="boton">Login</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="show_p.php">View user issues</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../service/show.php">View service requests</a>
                        </li>
                    </ul>
                    <a href="../user/logout_eng.php" class="boton">Log out</a>
                </div>
                <?php endif ?>
