...
$message .= "<li>Base rate: $" . number_format($base, 2) . " COP</li>";
$message .= "<li>Details of items and their prices:</li>";
...
$message .= "<li>Total cost: $" . number_format($costoTotal, 2) . " COP</li>";
